...
breed [ deadly-weeds deadly-weed ]
...
to setup
  ...
  create-red-wolves initial-number-red-wolves [
    set shape "wolf"
    set color red
    set size 4
    set energy random (2 * wolf-gain-from-food)
...
setxy random-xcor random-ycor
  ...
  create-werewolves initial-number-werewolves [
    set shape "wolf"
    set color gray
    set energy random (2 * wolf-gain-from-food)
    set size 6
...
create-vampires initial-number-vampire [
set shape "person"
set color magenta
set energy random (2 * wolf-gain-from-food)
set size 4
...
create-deadly-weeds initial-number-deadly-weeds [
set shape "plant"
set size 2
set color pink
setxy random-xcor random-ycor
...
ask deadly-weeds [
; Define actions for deadly weeds
if any? sheep-here [
ask one-of sheep-here [
set energy energy / 2
]
die
]
...
to reproduce-vampire ; wolf procedure
...
if random-float 100 < werewolves-reproduce [ ; throw "dice" to see if you will reproduce
set energy (energy / 2) ; divide energy between parent and offspring
hatch 1 [ rt random-float 360 fd 1 ] ; hatch an offspring and move it forward 1 step
]
end
...
to eat-red-wolves
let prey one-of red-wolves-here
if prey != nobody [
ask prey [ die ]
...
"" ""
PENS
"sheep" 1.0 0 -723837 true "" "plot count sheep"
"wolves" 1.0 0 -13345367 true "" "plot count wolves"
"red-wolves" 1.0 0 -8053223 true "" "plot count red-wolves"
" werewolves" 1.0 0 -7500403 true "" "plot count werewolves"
"vampires" 1.0 0 -13840069 true "" "plot count vampires"
